<template>
  <div id="Test">
    ...
    <div class="titlePhotos">
      <div class="firstPhoto">photo</div>
      <div class="secondSize">崔红雷 <br>ID:10005</div>
      <div class="secondMoney"><span>我的娃娃币</span><br><span>7959</span><br><img src="./images/recharge_btn.png" alt="" class="cztu"></div>
    </div>
...
<script>
  export default {
    ...
    methods: {
      tanceng: function () {
        let tanceng = document.getElementsByClassName('tanCeng')[0]
      ...
      out: function () {
        let outTc = document.getElementById('outTc')
